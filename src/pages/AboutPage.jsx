  ...
  return (
    <div className="min-h-screen bg-white pt-32 pb-24">
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        >
          <span className="text-accent font-bold uppercase tracking-widest text-sm mb-4 block">The Toliya Story</span>
          ...
          <p className="text-xl text-slate-500 max-w-3xl mx-auto leading-relaxed font-medium">
            Born from a passion for premium textiles, Toliya.co is dedicated to bringing the world-renowned quality of Pakistani cotton into the modern home.
          </p>
        </motion.div>
          ...
          >
            <div>
              ...
              <p className="text-lg text-slate-600 leading-relaxed font-medium">
                At Toliya.co, we believe that luxury should be felt, not just seen. Every towel in our collection is woven from 100% long-staple cotton, ensuring superior absorbency and a cloud-like softness that lasts for years.
              </p>
            </div>
