...
const SignupPage = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-50 px-4 pt-48 pb-20 relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-[500px] h-[500px] bg-emerald-900/5 rounded-full blur-[120px] -ml-64 -mt-64" />
      <div className="absolute bottom-0 right-0 w-[500px] h-[500px] bg-accent/5 rounded-full blur-[120px] -mr-64 -mb-64" />
      ...
      >
        <div className="text-center">
          ...
          <p className="text-slate-500 font-medium">
            ...
            <Link to="/login" className="text-emerald-900 font-bold hover:underline decoration-accent decoration-2 underline-offset-4">
              Sign in
            </Link>
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          >
            <svg className="w-5 h-5" viewBox="0 0 24 24">
              ...
              <path fill="#34a853" d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09 0-1.83.73-2.13 2.13-2.13 0 1.54-.58 2.09-1.36.04-1.36-.04-1.36-1.36-1.36z"/>
            </svg>
